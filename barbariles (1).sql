...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2026 a las 22:48:27
...
ALTER TABLE `pago`
  ...
  ADD UNIQUE KEY `idx_unq_sucursalpagada` (`ID_Sucursal`),
...
ALTER TABLE `pago`
  ...
  ADD CONSTRAINT `pago_ibfk_4` FOREIGN KEY (`ID_Sucursal`) REFERENCES `sucursal` (`ID_Sucursal`);
